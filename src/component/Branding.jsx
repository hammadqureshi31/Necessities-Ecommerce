...
const Branding = () => {
  ...
  const partnerLogos = [
    '/images/menswear.webp',
    '/images/manshopping.webp',
    '/images/manpaying.webp',
    '/images/leftbag.webp',
    '/images/rightbag.webp',
    '/images/chris.webp',
    '/images/markus.webp',
    '/images/manpaying.webp',
    '/images/rightbag.webp',
  ...
  return (
    <>
      <div
        className={`w-[${width}px] pt-14 flex flex-col text-center sm:w-[${width}px] md:w-[${width}px] md:pt-20`}
      >
        ...
        <div className="mt-14">
          <div className="">
            <h2 className="font-bold text-left px-2 mb-6 font-marg text-2xl md:ml-14">
              {" "}
              Our Brand Partners
            </h2>
                  ...
                  <span key={index} className="inline-block mr-8">
                    <div className="relative overflow-hidden w-36 h-36 border-4 ring-1 ring-sky-300 rounded-full hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
                      ...
                      <div className="absolute inset-x-0 bottom-0 bg-white text-center p-2">
                        <span className="text-gray-800 text-sm font-roboto font-semibold">
                          {partner}
                        </span>
                      </div>
                    </div>
