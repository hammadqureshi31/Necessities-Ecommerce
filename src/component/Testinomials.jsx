        ...
        <>
            ...
            >
                <motion.div
                    ...
                    className='w-72 h-48 mx-auto bg-gradient-to-br from-purple-400 to-indigo-600 rounded-lg overflow-hidden relative'
                >
                ...
                <motion.div
                    variants={itemVariants}
                    className='w-72 h-48 mx-auto bg-gradient-to-br from-pink-400 to-red-600 rounded-lg overflow-hidden relative'
                >
                    <div className='absolute inset-0 bg-white opacity-25'></div>
                    <div className='absolute inset-0 flex items-center justify-center'>
                ...
                <motion.div
                    variants={itemVariants}
                    className='w-72 h-48 mx-auto bg-gradient-to-br from-green-400 to-blue-600 rounded-lg overflow-hidden relative'
                >
                    <div className='absolute inset-0 bg-white opacity-25'></div>
                    <div className='absolute inset-0 flex items-center justify-center'>
                        <div className='bg-white w-64 h-40 rounded-lg p-4 shadow-md'>
                ...
                <motion.div
                    variants={itemVariants}
                    className='w-72 h-48 mx-auto bg-gradient-to-br from-yellow-400 to-orange-600 rounded-lg  overflow-hidden relative'
                >
                    <div className='absolute inset-0 bg-white opacity-25'></div>
                    <div className='absolute inset-0 flex items-center justify-center'>
                        <div className='bg-white w-64 h-40 rounded-lg p-4 shadow-md'>
