        ...
        <>
            <div className="py-10">
                ...
                <div className="px-4 pt-12">
                    <h2 className=" text-2xl md:text-3xl font-bold text-left  mb-16 font-aleg italic tracking-wider">Special Offers & Promotions</h2>
                    <div className="">
                        {/* Offer Card 1 */}
                        <div className="offer-card inline-block flex-1 max-w-sm rounded-lg overflow-hidden shadow-lg border border-transparent hover:border-purple-500 transition duration-300 bg-gradient-to-b from-blue-300 to-blue-500">
                        ...
                        {/* Offer Card 2 */}
                        <div className="offer-card inline-block flex-1 max-w-sm rounded-lg overflow-hidden shadow-lg border border-transparent hover:border-blue-500 transition duration-300 bg-gradient-to-b from-purple-400 to-purple-600">
                            <div className="p-6 text-white">
                        ...
                        {/* Offer Card 3 */}
                        <div className="offer-card inline-block flex-1 max-w-sm rounded-lg overflow-hidden shadow-lg border border-transparent hover:border-green-500 transition duration-300 bg-gradient-to-b from-pink-400 to-[#6E427A]">
                            <div className="p-6 text-white">
            ...
            <div className='flex flex-col gap-8 mt-20 md:flex-row md:justify-evenly mb-10 '>
                <div className=''>
                    <div className='flex flex-col gap-6 md:mt-4'>
                        <h5 className='text-2xl font-dance font-extrabold tracking-widest
            ...
            <div className="px-4 mt-14">
                <div className="">
                    <h2 className="text-3xl font-bold text-left mb-6 font-aleg italic tracking-wider"> Our Brand Partners</h2>
